...
\subsubsection{Description}
To register a user on the system is the same as to store biometric data of the user on the database.
Staff members needs to store their biometric data to gain access to department/building. There will be an administrator (admin user) that will handle all the registering of users on the system.
...
\textbf{ Post-conditions:} 
	\begin{itemize}
		\item The staff member is registered on the system with their biometric data.
