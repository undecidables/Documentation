The following fucntionality of creating and setting availability will only be available to staff members. Users who are not authorised by the system will only be granted read-only privileges.
